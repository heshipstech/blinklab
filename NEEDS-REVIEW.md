...
| ~~**CHANGELOG.md** absent while seven release tags exist; ROADMAP row 8.3 reads as entirely undone while REMEDIATION records it two-thirds done~~ **CLOSED 2026-08-20.** `CHANGELOG.md` exists and covers all seven releases plus an Unreleased section, written 15 August; ROADMAP 8.3 is ticked. This row described a state that ended five days before it was read again                                                                                                                                                                                   | Founder preference                                      | 30 min     |
