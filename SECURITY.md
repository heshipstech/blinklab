...
Use the **Email** contact link in the bar at the top of the published page,
https://heshipstech.github.io/blinklab/, the last of its three icon links, and
say in the subject line that the report is a security one. That reaches the
maintainer directly and keeps the report out of public issues while it is
being fixed. (Until 23 September 2026 this sentence put the link at the bottom
of the page; the page's footer carries no link, and the mailbox is one of the
nav bar's three icon links that docs/UI.md describes.)
