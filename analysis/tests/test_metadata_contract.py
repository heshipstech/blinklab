...
CONDITIONAL = {
    ...
    "frame_rate_after": "a camera session",
    "frame_rate_apply": "a camera session",
    "frame_rate_asked": "a camera session",
    ...
    "gaze_r2_bound": "a camera session",
    "gaze_r2_horizontal": "a camera session with a gaze profile",
    "gaze_r2_vertical": "a camera session with a gaze profile",
    ...
    "guided_conditions_match": "a camera session with a stored guided line",
    "guided_frame_size": "a camera session with a stored guided line",
    "guided_iris_width_px": "a camera session with a stored guided line",
    "guided_line_mm": "a camera session with a stored guided line",
    "guided_open_median_mm": "a camera session with a stored guided line",
